...
public class DisplayData extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB = new MyDatabaseMovie(DisplayData.this);
        ...
        displayDataArray();
        customAdapter=new CusAdapter(DisplayData.this, movie_id, movie_title, movie_year,movie_director, movie_artist, movie_rating, movie_review);
